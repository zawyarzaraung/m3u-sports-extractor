...
* **နောက်ဆုံး Update လုပ်ခဲ့သည့်အချိန်:** `2026-06-13 10:53 AM (မြန်မာစံတော်ချိန်)`
* **စုစုပေါင်း စစ်ဆေးခဲ့သည့် လိုင်းအရေအတွက်:** `158 လိုင်း`

| အခြေအနေ (Status) | လိုင်းအရေအတွက် | M3U Playlist Link | လုပ်ဆောင်ချက် |
| :--- | :---: | :--- | :--- |
| ✅ **Active Channels** | `96` | `https://raw.githubusercontent.com/zawyarzaraung/m3u-sports-extractor/main/playlist/active.m3u` | လက်ရှိ ကြည့်ရှု၍ရသော အားကစားလိုင်းများ |
| ⏳ **Dead Channels (စောင့်ကြည့်)** | `62` | `https://raw.githubusercontent.com/zawyarzaraung/m3u-sports-extractor/main/playlist/dead.m3u` | ဒေါင်းနေသဖြင့် ၅ ရက် စောင့်ကြည့်ဇုန်ထဲ ရောက်နေသောလိုင်းများ |
